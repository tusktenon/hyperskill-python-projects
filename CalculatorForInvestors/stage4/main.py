...
class App:
    ...
    def top_ten_menu(self):
        ...
        match input('Enter an option: '):
            case '0':
                return
            case '1':
                self.list_top_ten('ND/EBITDA')
            case '2':
                self.list_top_ten('ROE')
            case '3':
                self.list_top_ten('ROA')
            case _:
                print('Invalid option!')
    ...
    def list_top_ten(self, indicator):
        print('TICKER', indicator)
        for company, value in self.calculator.list_top_ten(indicator):
            print(company, round(value, 2))
