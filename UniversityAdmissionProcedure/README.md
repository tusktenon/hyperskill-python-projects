...
2. Read [the file](https://cogniterra.org/media/attachments/lesson/25376/applicant_list_6.txt) named *applicants.txt* once again. The file has the same structure as in the previous stage.
